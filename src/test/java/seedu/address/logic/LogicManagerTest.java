...
public class LogicManagerTest {
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs(), model.getCourseName());
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonCourseNameStorage courseNameStorage = new JsonCourseNameStorage(prefPath) {
            @Override
            public void saveCourse(ReadOnlyCourseName courseName, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        String addCommand = AddPersonCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + NUSNET_DESC_AMY + MAJOR_DESC_AMY;
        Person expectedPerson = new PersonBuilder(AMY).withAttendance().withTags().build();
    ...
    /**
     * Tests that the logic component correctly autocompletes the user input, ensuring the correctness
     * of the high level abstraction.
     */
    @Test
    void autoComplete() {
